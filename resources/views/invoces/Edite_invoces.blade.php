...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{route('invoces.update',$invoces->id)}}" method="post">
                @csrf
                @method('PATCH')
                    ...
                    <div class="row w-100">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <small class="form-text text-danger" >No Can edite Invoces Numper </small>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Invoices Date</label>
                                <input name="invoces_data" type="date"  value="{{$invoces->invoces_data}}"  class="form-control"  >
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="due_data" type="date"  value="{{$invoces->due_data}}"  class="form-control"  >
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                    </div>
                    <div class="row w-100" x-data="{
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="price_collection"  value="{{$invoces->price_collection}}" type="text"  class="form-control"  >
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                    </div>
                    <div class="row w-100">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="discount" type="text" value="{{$invoces->discount}}" x-model="discount" id="discount" class="form-control"  >
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="row w-100">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="value_vat" value="{{$invoces->value_vat}}"  type="text" x-model="(Price_Commission - discount)*tax/100" id="Pricevaluetax" class="form-control" readonly>
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="total" type="text"  value="{{$invoces->total}}" x-model="((Price_Commission - discount)*tax/100)+(Price_Commission - discount)" id="Pricetotal_tax" class="form-control" readonly>
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                    </div>
                    <div class="row w-100">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="note"  type="text"  value="{{$invoces->note}}"  class="form-control"  >
                                {{--<small class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                            </div>
                        </div>
                    </div>
