            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <div class="row justify-content-between">
                        ...
                        @permission('export_invoces')
                          <div class="">
                            <a href="{{ route('invocesPartExport') }}" class="btn btn-primary">Export Invoces</a>
                          </div>
                        @endpermission
                    </div>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Invoces part Paid</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Invoces part Paid</h3>
                </div>
                <!-- /.card-header -->
                                ...
                                <td colspan="2">
                                    <div class="dropdown" style="width: 50px">
                                        ...
                                        <div style="width: 50px" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{route('invoces-ditalis.edit',$invoce->id)}}">Show</a>
                                            <a class="dropdown-item" href="{{route('invoces.edit',[$invoce->id])}}">Edite</a>
                                            <div class="dropdown-item">
                                                <form action="{{route('softdelete',[$invoce->id])}}" method="post">
                                                    @csrf
                                                    <button class="btn btn-danger" type="submit">ToArchive</button>
                                                </form>
                                            </div>
                                            <div class="dropdown-item">
                                            ...
                                            <a class="dropdown-item" href="{{route('statusEdite',[$invoce->id])}}">Status Edite</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
